...
class WBCTask(object):
    ...
    vel_err: np.ndarray = np.zeros(nt)
    vel_des: np.ndarray = np.zeros(nt)
    acc_des: np.ndarray = np.zeros(nt)
    ...
    def update(self,
        ...
        """
            ...
            ref_x    is defined as [x y z qx qy qz qw leg1_pos_x leg1_pos_y leg1_pos_z ... leg4_pos_z], w.r.t. WCS, 19x1
            ref_xdot is defined as [vx vy vz wx wy wz leg1_vel_x leg1_vel_y leg1_vel_z ... leg4_vel_z], w.r.t. WCS, 18x1
        """
        pass
